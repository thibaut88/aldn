...
<!-- !PAGE CONTENT! -->
<div class="w3-main" style="margin-top:100px;margin-bottom:100px;">

  <div class="w3-container">
    <h5><b><i class="fa fa-dashboard"></i> Tableau de bord</b></h5>
  </div>
      <a href="pages/offers_tmp.php"><div class="w3-quarter">
      <div class=" w3-red">
        ...
        <h4 class="w3-padding-xlarge">Offres en attente</h4>
      </div>
    </div></a>
      <a href="pages/offers.php"><div class="w3-quarter">
      <div class=" w3-green">
        <div class="w3-left"><i class="fa fa-comment w3-xxxlarge"></i></div>
        <div class="w3-right">
          <h3>23</h3>
        ...
        <div class="w3-clear"></div>
        <h4 class="w3-padding-xlarge">Offres en ligne</h4>
      </div>
    </div></a>
      <a href="pages/articles.php"><div class="w3-quarter">
      <div class=" w3-light-green">
        ...
        <div class="w3-clear"></div>
        <h4 class="w3-padding-xlarge">Mes articles</h4>
      </div>
    </div></a>
      <a href="pages/users.php"><div class="w3-quarter">
      <div class=" w3-yellow">
        <div class="w3-left"><i class="fa fa-comment w3-xxxlarge"></i></div>
        <div class="w3-right">
          <h3>52</h3>
        ...
        <div class="w3-clear"></div>
        <h4 class="w3-padding-xlarge">Utilisateurs</h4>
      </div>
    </div></a>
      <a href="pages/partenaires.php"><div class="w3-quarter">
      <div class=" w3-light-blue">
        ...
        <div class="w3-clear"></div>
        <h4 class="w3-padding-xlarge">Nos partenaires</h4>
      </div>
    </div></a>	
  <div class="w3-clear"></div>
