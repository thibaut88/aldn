                            ...
                            <div class="col-sm-3" style='overflow-x:hidden'>
                                    ...
                                    <ul class="nav nav-pills nav-stacked">
										...
										<?php 
											...
											if($datas['is_gold']==1){ ?>
												<li>
												<a href="#" title="accès admin" alt="accès admin">
                            ...
                            <div id="accordion2" class="panel-group alternative">
								...
								<div class="panel panel-default">
										<div class="panel-heading">
                                            ...
                                            <a class="accordion-toggle" href="#" data-parent="#accordion2" data-toggle="collapse">
                                               Bienvenue  <small> <?= $datas['firstname'].' '.$datas['name'];?></small>
                                            </a>
                                        </h4><!--panel title -->
										<h4 class="panel-title">
                                            <a class="accordion-toggle" href="#" data-parent="#accordion2" data-toggle="collapse">
                                               Prénom : <small> <?= $datas['firstname'];?></small>
                                            </a>
                                        </h4><!--panel title -->
										<h4 class="panel-title">
                                            <a class="accordion-toggle" href="#" data-parent="#accordion2" data-toggle="collapse">
                                               Nom : <small> <?= $datas['name'];?></small>
                                            </a>
                                        </h4><!--panel title -->
										</div>
								</div>
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a class="accordion-toggle" href="#collapse2-One" data-parent="#accordion2" data-toggle="collapse">
                                               Pseudo : <small> <?= $datas['pseudo'];?></small>
                                            </a>
                                        </h4>
                                    </div><!-- fin panel heading  -->
									<!-- panel content -->
                                    <div id="collapse2-One" class="accordion-body collapse in">
                                        <div class="panel-body">
                                            <div class="row">
												...
												<input id="pseudo"class="w3-btn w3-white w3-border w3-hover-none"type="text"placeholder="<?= $datas['pseudo'];?>"name="pseudo">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a class="accordion-toggle" href="#collapse2-Two" data-parent="#accordion2" data-toggle="collapse">
                                               Adresse : <small> <?= $datas['adresse'];?></small>
                                            </a>
                                        </h4><!-- panel title  -->
                                    </div><!-- panel heading  -->
                                   ...
                                   <!-- debut form modifier adresse -->
									...
									<label class="w3-text-teal w3-show-block"for="<?= $datas['adresse'];?>">Changer l'adresse : </label>
									<input id="adresse"class="w3-btn w3-white w3-border w3-hover-none"type="text"placeholder="<?= $datas['adresse'];?>"name="addresse">
									<input type="submit"class="w3-btn w3-green"name="send"value="Changer">
                                        ...
                                        <div class="panel-body">
                                            <div class="row">
                                                <div class="col-md-12">
													...
													<input id="ville"class="w3-btn w3-white w3-border w3-hover-none"type="text"placeholder="<?= $datas['ville'];?>"name="city">
													<input type="submit"class="w3-btn w3-green"name="send"value="Changer">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a class="accordion-toggle" href="#collapse4-Four" data-parent="#accordion2" data-toggle="collapse">
                                               Code postal : <small> <?= $datas['code_postal'];?></small>
                                            </a>
                                        </h4><!-- panel title  -->
                                    </div><!-- panel heading  -->
                                   ...
                                   <!-- debut form modifier adresse -->
									<form  id="modify_adresse"action="<?= str_replace('index.php','',$_SERVER['SCRIPT_NAME']).'scripts/query_form_profil.php?id=$user_id';?>"method="post">
									<label class="w3-text-teal w3-show-block"for="<?= $datas['code_postal'];?>">Changer le code postal : </label>
									<input id="adresse"class="w3-btn w3-white w3-border w3-hover-none"type="text"placeholder="<?= $datas['code_postal'];?>"name="addresse">
									<input type="submit"class="w3-btn w3-green"name="send"value="Changer">
									</form><!-- form modifier adresse -->
                                        </div><!-- panel body  -->
                                    </div><!-- panel content   -->
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a class="accordion-toggle" href="#collapse5-Five" data-parent="#accordion2" data-toggle="collapse">
                                               Email : <small> <?= $datas['adresse_mail'];?></small>
                                            </a>
                                        </h4><!-- panel title  -->
                                    </div><!-- panel heading  -->
                                    <div id="collapse5-Five" class="accordion-body collapse">
										...
										<input id="mail"class="w3-btn w3-white w3-border w3-hover-none"type="text"placeholder="<?= $datas['adresse_mail'];?>"name="email">
										<input type="submit"class="w3-btn w3-green"name="send"value="Changer">
